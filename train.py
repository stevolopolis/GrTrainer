...
for epoch in tqdm(range(1, params.EPOCHS + 1)):
    ...
    torch.save(model.state_dict(), os.path.join(params.MODEL_PATH, f"grconvCLS_epoch{epoch}.pth"))

torch.save(model.state_dict(), os.path.join(params.MODEL_PATH, f"grconvCLS_final.pth"))